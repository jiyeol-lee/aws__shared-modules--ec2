...
- CloudWatch monitoring with optional CPU alarm (works with basic or detailed monitoring)
...
| enable_monitoring                 | Enable detailed CloudWatch monitoring (1-minute granularity). Costs ~$2.10/month. Note: CPU alarms work with basic monitoring too. | `bool`         | `false`                                                                |    no    |
...
| create_cpu_alarm                  | Create CloudWatch CPU utilization alarm. Works with both basic (5-min) and detailed (1-min) monitoring.                            | `bool`         | `false`                                                                |    no    |
